...
class Graphics:
    infile = 'C:\\Users\\LEGION\\Pictures\\Saved Pictures\\new2.jpg'
    outfile = 'C:\\Users\\LEGION\\Pictures\\Saved Pictures\\new3.jpg'

    @classmethod
    def fixed_size(cls, width, height):
        """按照固定尺寸处理图片"""
        im = Image.open(cls.infile).convert('RGB')
